---
title: "Hands-On Exercise 5e:</br>Treemap Visualisation with R"
...
Read [Introduction to dplyr](https://cran.r-project.org/web/packages/dplyr/vignettes/dplyr.html) before moving on to the next section.
:::
...
::: callout-note
-   More about pipe: [Pipes in R Tutorial For Beginners](https://www.datacamp.com/community/tutorials/pipe-r-tutorial).
:::
...
**treemapify** is a R package specially developed to draw treemaps in **ggplot2**. In this section, we will learn how to design treemaps closely resembling treemaps designed in previous section by using **treemapify**.

References: [Introduction to “treemapify”](https://cran.r-project.org/web/packages/treemapify/vignettes/introduction-to-treemapify.html) and its [user guide](https://cran.r-project.org/web/packages/treemapify/treemapify.pdf).
