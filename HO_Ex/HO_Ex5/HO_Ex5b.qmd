---
title: "Hands-On Exercise 5b:</br>Visual Correlation Analysis"
...
In this hands-on exercise, to plot data visualisation for visualising correlation matrix with R. It consists of three main sections. First, to create correlation matrix using [*pairs()*](https://www.rdocumentation.org/packages/graphics/versions/3.6.0/topics/pairs) of R Graphics. Next, to plot corrgram using **corrplot** package of R. Lastly, to create an interactive correlation matrix using plotly R.
...
There are more than one way to build scatterplot matrix with R. In this section, to create a scatterplot matrix by using the *pairs* function of R Graphics. Syntax description of [*pairs*](https://stat.ethz.ch/R-manual/R-devel/library/graphics/html/pairs.html)function.
...
### Drawing the lower and upper corners
...
Display the upper half of the correlation matrix by using the code below.
...
The are at least three R packages provide function to plot corrgram, they are: - [corrgram](https://cran.r-project.org/web/packages/corrgram/) - [ellipse](https://cran.r-project.org/web/packages/ellipse/) - [corrplot](https://cran.r-project.org/web/packages/corrplot/)

On top that, some R package like ggstatsplot package also provides functions for building corrgram.

In this section, how to visualising correlation matrix by using [*ggcorrmat()*](https://indrajeetpatil.github.io/ggstatsplot/reference/ggcorrmat.html) of [**ggstatsplot**](https://indrajeetpatil.github.io/ggstatsplot/) package.
...
Read [An Introduction to corrplot Package](https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html) in order to gain basic understanding of **corrplot** package.
...
Which pair of variables has correlation coefficients that are statistically significant.
